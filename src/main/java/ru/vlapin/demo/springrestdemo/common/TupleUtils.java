...
public class TupleUtils {
  ...
  public <@NotNull T1, @NotNull T2, @NotNull T3> @NotNull Tuple3<T1, T2, T3> tupleWith(
      @NotNull T1 self,
      @NotNull T2 t2,
      @NotNull T3 t3) {
  ...
  public <@NotNull T1, @NotNull T2, @NotNull T3, @NotNull T4> @NotNull Tuple4<T1, T2, T3, T4> tupleWith(
      @NotNull T1 self,
      @NotNull T2 t2,
      @NotNull T3 t3,
      @NotNull T4 t4) {
